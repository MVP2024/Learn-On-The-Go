...
class Lesson(models.Model):
    ...
    class Meta:
        ...
        ordering = ['discipline', 'section', 'lesson_order']  # Сортировка по дисциплине, разделу, номеру урока
...
class UserLessonProgress(models.Model):
    ...
    current_time = models.FloatField(
        default=0.0,
        verbose_name='Текущее время воспроизведения (сек)'
    )
    watched_duration = models.IntegerField(
        default=0,
        verbose_name='Просмотрено секунд'
    )
    ...
    class Meta:
        ...
        unique_together = ('user', 'lesson') # Один прогресс на одного пользователя на один урок
