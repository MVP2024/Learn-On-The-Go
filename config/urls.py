...
urlpatterns = [
    ...
    # Webhook для ЮKassa — регистрируем до include(router.urls), чтобы
    # маршрут /api/payments/yookassa-webhook/ не перехватывался роутером payments/{pk}/
    path(
